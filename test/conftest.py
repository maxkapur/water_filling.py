...
@pytest.fixture(
    ...
    params=[
        ...
        WaterFillingTriple([1.0, 2, 3, 4], 0.5, 1.5),
        WaterFillingTriple([1.0, 2, 3, 4], 2.0, 2.5),
        WaterFillingTriple([1, 2, 3, 4], 6, 4),
        WaterFillingTriple([1, 2, 3, 4], 30, 10.0),
        WaterFillingTriple([-1, 2, -3, -4], 0.0, -4.0),
        WaterFillingTriple([-1, 2, -3, -4], 0.5, -3.5),
        WaterFillingTriple([-1.0, 2.0, -3.0, -4.0], 8, 0.0),
        WaterFillingTriple([-1.0, 2.0, -3.0, -4.0], 12.5, 1.5),
        WaterFillingTriple([-1.0, 2.0, -3.0, -4.0], 14.0, 2),
        WaterFillingTriple([-1.0, 2.0, -3.0, -4.0], 18.0, 3.0),
